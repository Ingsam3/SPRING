...
@SequenceGenerator(//@SequenceGenerator는 시퀀스 생성기를 설정하는 애노테이션
		name="member3_no_seq_gename", //시퀀스 제너레이터 이름
		sequenceName="member3_no_seq", //시퀀스 이름
		initialValue=1, //시작값
...
public class MemberRole {//회원이 가지는 권한
	  ...
	  @GeneratedValue(
				...
				generator="member3_no_seq_gename" //식별자 생성기를 설정해놓은 member_no_seq_gename 시퀀스 제너레이터 이름 으로 설정
				)
	  private int fno;
