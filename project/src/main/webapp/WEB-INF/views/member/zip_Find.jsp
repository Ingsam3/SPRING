...
<SCRIPT>
   ...
   function check(form) {
      if (form.dong.value == "") {
         alert("도로명 또는 지번을 입력해 주세요!");
         form.dong.focus();
         return false; //데이터를 서버로 보내는 이벤트를 종료시킨다
      }
   }
</SCRIPT>
<style type="text/css">
      ...
      <table width="414" height="100" border="0" align="center"
         ...
         <tr>
            <td bgcolor="f5ffea" align="center"><strong><font
                  color="#466d1b"><span class="style1">[거주지의  도로명 또는 지번을 입력하고
         ...
         <tr height="30">
            <td bgcolor="f5ffea" align="center"><input type="text"
               ...
               <%--input type="image" 는
            	   이미지 삽입 기능이 있어서 버튼을 보기 좋게 하고 데티어를 서버로 보내는 기능도 있다(submit) --%>
         </tr>
         <%
            //if(dong != null){
         %>
